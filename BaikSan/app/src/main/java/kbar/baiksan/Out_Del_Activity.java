...
//주문취소출고
/*
 * 스캔 - 출고내역조회(이미 출고된 바코드인지 ) - 재고조회(출고할 재고가 있는지) - 출고처리(구분=0)
 * */
public class Out_Del_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.out_del_activity);
        ...
        btn_scan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //카메라 스캔
                IntentIntegrator integrator = new IntentIntegrator(Out_Del_Activity.this);
        ...
        btn_can.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Out_Del_Activity.this, Out_sub_Activity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void insert_out(String bar,String order_no, String roll_no, String s_qty, String oqty, String ea){
        class phpUp extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    data += "&" + URLEncoder.encode("gubun", "UTF-8") + "=" + URLEncoder.encode("1", "UTF-8");  //0:정상출고 1:주문취소출고
        ...
        task1.execute();
        Toast.makeText(Out_Del_Activity.this, "주문취소출고 완료!\n(" + bar + ")", Toast.LENGTH_SHORT).show();
